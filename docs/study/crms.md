...
You will need to be added to the study team on CRMS before you can access and edit participants. To do so, you can either be added by an existing lab member who is already on the study team, or you can [submit a ticket](https://helpdesk.pmacs.upenn.edu) via the PennCRMS service desk. See CRMS [FAQ](https://www.med.upenn.edu/clinicalresearch/assets/user-content/secure/5-penncrms/penncrms-faq-january-2024.pdf) 
